...
func RegisterTransactionServiceServer(any, TransactionServiceServer) {}
func NewTransactionServiceClient(any) TransactionServiceClient {
	return nil
}
...
var _ = empty.ETOOEMPTY
var _ = timestamp.ETOOEMPTY